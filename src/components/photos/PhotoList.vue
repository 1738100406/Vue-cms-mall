    ...
    <div id="slider" class="mui-slider">
      ...
      >
        <div class="mui-scroll">
          ...
          <a class="mui-control-item" href="#item5mobile" data-wid="tab-top-subpage-5.html">aaa</a>
          <a class="mui-control-item" href="#item5mobile" data-wid="tab-top-subpage-5.html">bbb</a>
          <a class="mui-control-item" href="#item5mobile" data-wid="tab-top-subpage-5.html">ccc</a>
        </div>
      </div>
    </div>
